...
public:
    typedef enum StackWalkOptions
    {
        ...
        RetrieveVerbose = 0xF,      // Contains all the abouve
    ...
    typedef BOOL(__stdcall *PReadProcessMemoryRoutine)(HANDLE, DWORD64, PVOID, DWORD, LPDWORD, LPVOID);
    ...
    BOOL DumpCrash(PEXCEPTION_POINTERS pExceptionInfo,std::string strCrashpath);
